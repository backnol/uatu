class TwUsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tw_user.save
        format.html { redirect_to @tw_user, notice: 'Twitter user was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tw_user.update(tw_user_params)
        format.html { redirect_to @tw_user, notice: 'Twitter user was successfully updated.' }
  ...
  def destroy
    @tw_user.destroy
    respond_to do |format|
      format.html { redirect_to tw_users_url, notice: 'Twitter user was successfully destroyed.' }
  ...
  private
    ...
    def tw_user_params
      params.require(:tw_user).permit(:screen_name, :name, :description, :profile_image_url, :profile_image_url_https)
    end
end
